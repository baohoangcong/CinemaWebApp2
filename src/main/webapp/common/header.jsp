      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav nav-menu text-uppercase ms-auto py-4 py-lg-0 navbar">
            <li class="nav-item">
              <div class="dropdown">
				    <a class="nav-link">Khách Hàng 
				      <i class="fa fa-caret-down"></i>
				    </a>
				    <div class="dropdown-content">
				      <a class="nav-link" href="${pageContext.request.contextPath}/admin/listkhachhang">Danh sách Khách Hàng</a>
				      <a class="nav-link" href="${pageContext.request.contextPath}/admin/listlichsu">Lịch Sử Dịch Vụ</a>
            ...
            <li class="nav-item">
              ...
              <div class="dropdown">
				    ...
				    <div class="dropdown-content">
				      <a class="nav-link" href="${pageContext.request.contextPath}/admin/dichvu/list">QL Dịch Vụ</a>
				      <a class="nav-link" href="${pageContext.request.contextPath}/admin/khuyenmai/list">QL Khuyến Mãi</a>
				    </div>
				  </div>
            </li>
            <li class="nav-item">
            	<div class="dropdown">
				    ...
				    <div class="dropdown-content">
				      ...
				      <a class="nav-link" href="${pageContext.request.contextPath}/admin/phim/listPhimDangChieu">Phim</a>
				    </div>
				  </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
					<a class="btn-hover btn-header hover-white" href="${pageContext.request.contextPath}/dangxuat"><span style="color:white">Đăng Xuất </span></a>
			</li>
          </ul>
        </div>
      </div>
