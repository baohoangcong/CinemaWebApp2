...
<body>
	<%@ include file="/common/header.jsp"%>
		...
		<div class="container p-5" style="margin-top: 100px; margin-bottom: 100px; width: 500px">
			...
			<div>
				<a href="${pageContext.request.contextPath}/admin/suatchieu/list" class="btn btn-dark">Danh Sách Suất Chiếu</a>
			</div>
			
			<form:form action="${pageContext.request.contextPath}/admin/suatchieu/save" method="post" modelAttribute="suatChieuForm">
				...
				<div class="form-group">
					...
					<%-- <form:select path="phim.maPhim" items="${phims}" itemValue="maPhim" itemLabel="tenPhim" class="form-control" readonly="true"></form:select> --%>
					<form:input path="phim.maPhim" name="phim" id="phim" class="form-control" readonly="true"/>
					<div class="text-danger">
				...
				<div class="form-group">
					...
					<%-- <form:select path="phongChieu.maPhongChieu" items="${phongchieus}" itemValue="maPhongChieu" itemLabel="maPhongChieu" class="form-control" readonly="true"></form:select> --%>
					<form:input path="phongChieu.maPhongChieu" name="phongchieu" id="phongchieu" class="form-control" readonly="true"/>
					<div class="text-danger">
				...
				<div class="form-group">
					...
					<form:input type="date" path="ngayChieu" name="ngayChieu" id="ngayChieu" class="form-control"/>
					<div class="text-danger">
				...
				<div class="form-group">
					...
					<form:input type="time" path="gioBatDau" name="gioBatDau" id="gioBatDau" class="form-control"/>
					<div class="text-danger">
				...
				<div class="form-group">
					...
					<form:input type="time" path="gioKetThuc" name="gioKetThuc" id="gioKetThuc" class="form-control"/>
					<div class="text-danger">
