...
<body class="d-flex flex-row justify-content-center">
	...
	<div class="main-body container mt-3">
		<main class="form-signin w-100 m-auto">
			<form id="loginForm" action="misspass" method="post" modelAttribute="misspass">
				<img class="mb-4"
				...
				<div class="form-floating">
					<input type="text" class="form-control" id="account"
						placeholder="Password" path="account" value ="${loggedInUser}" name="account" readonly> <label
				...
				<div class="form-floating">
					<input type="password" class="form-control" id="repassword"
						path="repassword" placeholder="Password" name="repassword"> <label
						path="repassword">Nhập Lại Mật Khẩu Mới</label>
