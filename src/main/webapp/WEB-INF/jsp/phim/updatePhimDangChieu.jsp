...
SinhDN
30/08/1998
Trang cập nhật phim đang chiếu
 -->
...
<head>
<meta charset="UTF-8">
<title>Cập Nhật Phim Đang Chiếu</title>
...
<body class="d-flex flex-row justify-content-center">
	...
	<div class="main-body" style="margin-top: 100px; margin-bottom: 100px; width: 500px">
			<!-- Form update -->
				<h1>Cập Nhật Phim</h1>
				<form:form
					action="${pageContext.request.contextPath}/admin/phim/updatephimdangchieu"
					...
					modelAttribute="themphim">
						...
						<div class="form-group">
							<form:label path="moTaPhim">Mô Tả Phim<span
										class="rq">*</span> :</form:label>
							<form:input class="form-control"
									path="moTaPhim" readonly="true" />
							<form:errors path="moTaPhim"
									cssClass="errors" />
						</div>
						<div class="form-group">
							...
							<form:textarea rows="9" cols="70" class="form-control"
									path="noiDungPhim" readonly="true" />
						...
						<div class="form-group">
							...
							<form:input type="date"
									class="form-control" path="ngayKhoiChieu" readonly="true" />
						...
						<div class="form-group">
							<div id="loadfile" style="display: none;"><button class="btn btn-info mt-3"
								...
								style="display: none;">
								<div style="position: relative;" id="mydiv" class="col-lg-4 col-sm-6 mb-4"></div>
								</div>
