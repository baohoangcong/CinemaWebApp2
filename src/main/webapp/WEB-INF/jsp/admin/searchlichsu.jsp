...
<body class="d-flex flex-row justify-content-center">
	...
	<div
		...
		<div class="container">
			<h1 align="center">List Lich Sử Khách Hàng</h1>
		</div>
...
<br>
		...
		<div class="pagination">
			<c:if test="${currentPage > 1}">
				<a href="searchlichsu?page=${currentPage-1}&tenKhachHang=${tenKhachHang1}" class="btn btn-light btn-direction">&laquo;
					Previous</a>
			</c:if>
				...
				<c:choose>
					...
					<c:otherwise>
						<c:if
							...
							<a href="searchlichsu?page=${i}&tenKhachHang=${tenKhachHang1}">${i}</a>
						</c:if>
			...
			<c:if test="${currentPage lt totalPages}">
				<a href="searchlichsu?page=${currentPage+1}&tenKhachHang=${tenKhachHang1}" class="btn btn-light btn-direction">Next
					&raquo;</a>
			</c:if>
		</div>
	</div>
