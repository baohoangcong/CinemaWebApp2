...
<body class="d-flex flex-row justify-content-center">
	...
	<div
		...
		<div class="mb-3">
			<a href="/CinemaWebApp/admin/listlichsu" class="btn btn-dark">Về Trang Lich Sử Khách Hàng</a>
		</div>
			...
			<div class="pagination">
				<c:if test="${currentPage > 1}">
					<a href="?page=${currentPage-1}" class="btn btn-light btn-direction">&laquo;
						Previous</a>
				</c:if>
				...
				<c:if test="${currentPage lt totalPages}">
					<a href="?page=${currentPage+1}" class="btn btn-light btn-direction">Next
						&raquo;</a>
				</c:if>
			</div>
