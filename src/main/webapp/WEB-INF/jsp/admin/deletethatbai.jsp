	...
	<div
		...
		<div class="pagination">
			<c:if test="${currentPage > 1}">
				<a href="/CinemaWebApp/admin/listkhachhang?page=${currentPage-1}"
					class="btn btn-light">&laquo; Previous</a>
			</c:if>
				...
				<c:choose>
					...
					<c:otherwise>
						<c:if
							...
							<a href="/CinemaWebApp/admin/listkhachhang?page=${i}" class="btn">${i}</a>
						</c:if>
