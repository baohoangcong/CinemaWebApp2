...
<body>
	<%@ include file="/common/header.jsp"%>
		...
		<div class="container p-5" style="margin-top: 100px; margin-bottom: 100px; width: 500px">
			...
			<form:form action="${pageContext.request.contextPath}/admin/phongchieu/save" method="post" modelAttribute="PhongchieuForm">
			
				<div class="form-group">
					<form:label path="maPhongChieu" class="col-form-label">Mã Phòng Chiếu</form:label>
					<form:input path="maPhongChieu" name="maPhongChieu" id="maPhongChieu" class="form-control"/>
				...
				<br>
				<div class="col-auto">
					<form:button type = "submit" name="add" id="add" class="btn btn-success">Add</form:button>
				</div>
