...
<body class="d-flex flex-row justify-content-center">
	...
	<div
		...
		<div class="container">
			<div>
				<h2 class="section-heading text-uppercase fw-bold" align="center" style="font-size: 50px;">Danh sách
					dịch vụ</h2>
				<div class="">
					<div>
					<a href="${pageContext.request.contextPath}/admin/dichvu/them" class="btn" style="margin-bottom:-120px;font-size: 30px;">Thêm dịch vụ</a>
					</div>
					<div>
						<p>${messageUpdate}</p>
						<form
						...
						<c:forEach var="abc" items="${dichvus}" varStatus="status">
							...
							<tr>
								...
								<a
									...
									onclick="return confirm('Bạn có muốn chỉnh sửa không?')" class="btn">CHỈNH SỬA</a>
								<a
