...
public class SuDungDichVuRepository {
	...
	/*
	 * Project: Cinema WebApp Team: 2 Author : Ducnm74 Method: lấy số doanh thu dịch
	...
	/*
	 * Project: Cinema WebApp Team: 2 Author : Ducnm74 Method: Lấy tổng chi tiêu sử
	 * dụng dịch vụ của Khách hàng trong năm hiện tại
	 */
