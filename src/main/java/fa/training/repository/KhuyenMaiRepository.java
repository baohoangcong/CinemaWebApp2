...
public class KhuyenMaiRepository {
	...
	public List<KhuyenMai> search(String searchKey) {
		Session session = sessionFactory.getCurrentSession();
		Query<KhuyenMai> createQuery = session.createQuery("SELECT d FROM KhuyenMai d where d.maKhuyenMai like :searchKey or d.tenKhuyenMai like :searchKey or d.moTaKhuyenMai like :searchKey or d.tiLeKhuyenMai like :searchKey",
				KhuyenMai.class);
