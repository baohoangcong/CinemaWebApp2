...
//	 * Project:Cinema WebApp
//	 * 
//	 * @author TuNC8 Form Đăng Nhập
//	 */
//	@PostMapping()
//	public String dangnhap(@ModelAttribute("taikhoan") TaiKhoan taiKhoan, HttpServletRequest request,
...
//
	 ...
	 * Project:Cinema WebApp
	 * 
	 * @author TuNC8 Form Đăng Nhập (Dùng để cop đường link sang 1 cửa sổ mới thì ta
	 *         phải dùng Get)
	 */
//	@GetMapping("/dangnhap")
//	public String getDangNhap(HttpServletRequest request) {
//		HttpSession session = request.getSession();
